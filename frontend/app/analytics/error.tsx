  ...
  return (
    <div className="min-h-[40vh] flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-card-dark border border-panel-border rounded-2xl p-8 shadow-lg text-center">
        <h2 className="text-xl font-bold text-white mb-2">Analytics failed to load</h2>
        <p className="text-slate-400 text-sm mb-6">
          {error.message || "Something went wrong loading analytics. Check your connection and try again."}
        </p>
